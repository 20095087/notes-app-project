...
class NoteAPITest {
    ...
    @BeforeEach
    fun setup() {
        learnKotlin = Note("Learning Kotlin", 5, "College", "todo","this is a test",false)
        summerHoliday = Note("Summer Holiday to France", 1, "Holiday","todo", "this is a test",false)
        codeApp = Note("Code App", 4, "Work", "todo","this is a test",true)
        testApp = Note("Test App", 4, "Work", "todo","this is a test",false)
        swim = Note("Swim - Pool", 3, "Hobby", "todo","this is a test",true)
    ...
    inner class AddNotes {
        ...
        fun `adding a Note to a populated list adds to ArrayList`() {
            val newNote = Note("Study Lambdas", 1, "College", "todo","this is a test",false)
    ...
    inner class UpdateNotes {
        ...
        fun `updating a note that does not exist returns false`() {
            assertFalse(populatedNotes!!.updateNote(6, Note("Updating Note", 2, "Work", "hi","this is a test",false)))
            assertFalse(populatedNotes!!.updateNote(-1, Note("Updating Note", 2, "Work", "banjo","this is a test",false)))
            assertFalse(emptyNotes!!.updateNote(0, Note("Updating Note", 2, "Work", "yes","this is a test",false)))
        }
        ...
        fun `updating a note that exists returns true and updates`() {
            ...
            assertTrue(populatedNotes!!.updateNote(4, Note("Updating Note", 2, "College","todo","this is a test", false)))
