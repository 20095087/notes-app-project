...
class NoteAPITest {
    ...
    fun setup() {
        ...
        summerHoliday = Note("Summer Holiday to France", 1, "Holiday","todo", false)
        codeApp = Note("Code App", 4, "Work", "todo",true)
        testApp = Note("Test App", 4, "Work", "todo",false)
        swim = Note("Swim - Pool", 3, "Hobby", "todo",true)
    ...
    inner class UpdateNotes {
        ...
        fun `updating a note that exists returns true and updates`() {
            ...
            assertTrue(populatedNotes!!.updateNote(4, Note("Updating Note", 2, "College","todo", false)))
